...
public class BellringerEntity extends BossEntity {
	...
	public BellringerEntity(EntityType<? extends BellringerEntity> type, Level worldIn) {
		...
		setItemInHand(InteractionHand.MAIN_HAND, new ItemStack(MYFItems.bellringerStaff.get()));
	}
	...
	public static void spawn(Player player, Level world) {
		...
		BellringerEntity bellringer = MYFEntities.THE_MORMAYII.get().create(world);
	...
	protected ResourceLocation getDefaultLootTable() {
		return AkonixBoss.rl("the_mormayii");
	}

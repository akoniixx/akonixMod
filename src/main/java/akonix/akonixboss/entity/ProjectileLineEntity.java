...
public class ProjectileLineEntity extends ProjectileBossAbstract {
	...
	public static final int VAR_BELLRINGER = 0, VAR_DAME_FORTUNA = 1, VAR_THE_JOCKPAD = 2;
	...
	protected boolean canHitEntity(Entity target) {
		if (getVariant() == VAR_THE_JOCKPAD && (target instanceof RoseSpiritEntity || target instanceof RosalyneEntity)) return false;

...
public class BellringerModel extends HumanoidModel<BellringerEntity> {
	public static final ModelLayerLocation MODEL = new ModelLayerLocation(AkonixBoss.rl("bellringer"), "main");
	public static final ModelLayerLocation MODEL_HEAD = new ModelLayerLocation(AkonixBoss.rl("bellringer"), "head");

...
public class DameFortunaModel extends HumanoidModel<DameFortunaEntity> {
	public static final ModelLayerLocation MODEL = new ModelLayerLocation(AkonixBoss.rl("dame_fortuna"), "main");
	public static final ModelLayerLocation MODEL_ARMOR = new ModelLayerLocation(AkonixBoss.rl("dame_fortuna"), "armor");
	public static final ModelLayerLocation MODEL_HEAD = new ModelLayerLocation(AkonixBoss.rl("dame_fortuna"), "head");

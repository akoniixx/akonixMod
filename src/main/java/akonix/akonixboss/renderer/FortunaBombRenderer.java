...
import akonix.akonixboss.entity.FortunaBombEntity;
...
public class FortunaBombRenderer extends EntityRenderer<FortunaBombEntity> {
	private static final ResourceLocation TEXTURE = AkonixBoss.rl("textures/entity/fortuna_dice.png");
	private static final ResourceLocation TEXTURE_WARNING = AkonixBoss.rl("textures/entity/fortuna_dice_white.png");

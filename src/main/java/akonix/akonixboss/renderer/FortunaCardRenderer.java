...
import akonix.akonixboss.entity.FortunaCardEntity;
...
public class FortunaCardRenderer extends EntityRenderer<FortunaCardEntity> {
	private static final ResourceLocation[] TEXTURES = {
			AkonixBoss.rl("textures/entity/fortuna_card_club.png"),
			AkonixBoss.rl("textures/entity/fortuna_card_heart.png"),
			AkonixBoss.rl("textures/entity/fortuna_card_diamond.png"),
			AkonixBoss.rl("textures/entity/fortuna_card_spade.png"),
			AkonixBoss.rl("textures/entity/fortuna_card_amogus.png") //shh don't tell anyone
	};
	private static final RenderType[] TEXTURES_OVERLAY = {
			RenderType.entityTranslucentEmissive(AkonixBoss.rl("textures/entity/fortuna_card_ask_club.png"), false),
			RenderType.entityTranslucentEmissive(AkonixBoss.rl("textures/entity/fortuna_card_ask_heart.png"), false),
			RenderType.entityTranslucentEmissive(AkonixBoss.rl("textures/entity/fortuna_card_ask_diamond.png"), false),
			RenderType.entityTranslucentEmissive(AkonixBoss.rl("textures/entity/fortuna_card_ask_spade.png"), false),
			RenderType.entityTranslucentEmissive(AkonixBoss.rl("textures/entity/fortuna_card_ask_amogus.png"), false) //shh don't tell anyone
		};
	private static final ResourceLocation TEXTURE_HIDDEN = AkonixBoss.rl("textures/entity/fortuna_card_hidden.png");

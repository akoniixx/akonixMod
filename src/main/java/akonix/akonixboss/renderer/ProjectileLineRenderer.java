...
import akonix.akonixboss.entity.ProjectileLineEntity;
...
public class ProjectileLineRenderer extends EntityRenderer<ProjectileLineEntity> {
	private static final ResourceLocation[] TEXTURES = {
			AkonixBoss.rl("textures/entity/projectile_bellringer.png"),
			AkonixBoss.rl("textures/entity/projectile_dame_fortuna.png"),
			AkonixBoss.rl("textures/entity/projectile_rose.png")
			};

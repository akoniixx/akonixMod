...
public class RosalyneGlowLayer extends RenderLayer<RosalyneEntity, RosalyneModel> {
	...
	private static final RenderType COFFIN_GLOW = RenderType.entityTranslucentEmissive(AkonixBoss.rl("textures/entity/rosalyne_coffin_glow.png"), false), 
			BASE_GLOW = RenderType.entityTranslucentEmissive(AkonixBoss.rl("textures/entity/rosalyne_glow.png"), false);

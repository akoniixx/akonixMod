...
public class RosalyneRenderer extends MobRenderer<RosalyneEntity, RosalyneModel> {
	public static final ResourceLocation BASE = AkonixBoss.rl("textures/entity/rosalyne.png"),
			COFFIN = AkonixBoss.rl("textures/entity/rosalyne_coffin.png"),
			CRACKED = AkonixBoss.rl("textures/entity/rosalyne_cracked.png");

...
public class SwampjawModel extends EntityModel<SwampjawEntity> {
	public static final ModelLayerLocation MODEL = new ModelLayerLocation(AkonixBoss.rl("swampjaw"), "main");
	public static final ModelLayerLocation MODEL_HEAD = new ModelLayerLocation(AkonixBoss.rl("swampjaw"), "head");
